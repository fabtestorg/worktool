...
echo '#生成tls证书'
FABRIC_CA_CLIENT_HOME=$PWD/crypto-config/rootca/admin $TOOL enroll -u http://admin:adminpw@localhost:7054 -d=true
FABRIC_CA_CLIENT_HOME=$PWD/crypto-config/rootca/admin $TOOL register --id.name orderer.example.com --id.type orderer --id.secret=123456 -u http://admin:adminpw@localhost:7054
FABRIC_CA_CLIENT_HOME=$PWD/crypto-config/ordererOrganizations/example.com/orderers/orderer.example.com/tmptlscerts $TOOL enroll -u http://orderer.example.com:123456@localhost:7054 --csr.hosts orderer.example.com,orderer
...
mkdir -p $PWD/crypto-config/ordererOrganizations/example.com/msp/intermediatecerts/
...
cp $PWD/crypto-config/ordererOrganizations/example.com/admin/msp/intermediatecerts/*.pem $PWD/crypto-config/ordererOrganizations/example.com/msp/intermediatecerts/
cp $PWD/crypto-config/ordererOrganizations/example.com/orderers/orderer.example.com/tmptlscerts/msp/cacerts/*.pem $PWD/crypto-config/ordererOrganizations/example.com/msp/tlscacerts/tlsca.example.com-cert.pem
...
cat $PWD/crypto-config/ordererOrganizations/example.com/admin/msp/intermediatecerts/*.pem >> $PWD/crypto-config/ordererOrganizations/example.com/users/Admin@example.com/tls/ca.crt
...
cp $PWD/crypto-config/ordererOrganizations/example.com/orderers/orderer.example.com/tmptlscerts/msp/cacerts/*.pem $PWD/crypto-config/ordererOrganizations/example.com/orderers/orderer.example.com/tls/ca.crt
cp $PWD/crypto-config/ordererOrganizations/example.com/orderers/orderer.example.com/tmptlscerts/msp/signcerts/*.pem $PWD/crypto-config/ordererOrganizations/example.com/orderers/orderer.example.com/tls/server.crt
cp $PWD/crypto-config/ordererOrganizations/example.com/orderers/orderer.example.com/tmptlscerts/msp/keystore/*_sk $PWD/crypto-config/ordererOrganizations/example.com/orderers/orderer.example.com/tls/server.key
...
mkdir -p $PWD/crypto-config/peerOrganizations/org1.example.com/msp/intermediatecerts/
...
cp $PWD/crypto-config/peerOrganizations/org1.example.com/admin/msp/intermediatecerts/*.pem $PWD/crypto-config/peerOrganizations/org1.example.com/msp/intermediatecerts/
...
cat $PWD/crypto-config/peerOrganizations/org1.example.com/admin/msp/intermediatecerts/*.pem >> $PWD/crypto-config/peerOrganizations/org1.example.com/msp/tlscacerts/tlsca.org1.example.com-cert.pem
...
cat $PWD/crypto-config/peerOrganizations/org1.example.com/admin/msp/intermediatecerts/*.pem >> $PWD/crypto-config/peerOrganizations/org1.example.com/users/Admin@org1.example.com/tls/ca.crt
...
cat $PWD/crypto-config/peerOrganizations/org1.example.com/peers/peer0.org1.example.com/msp/intermediatecerts/*.pem >> $PWD/crypto-config/peerOrganizations/org1.example.com/peers/peer0.org1.example.com/tls/ca.crt
...
cat $PWD/crypto-config/peerOrganizations/org1.example.com/peers/peer1.org1.example.com/msp/intermediatecerts/*.pem >> $PWD/crypto-config/peerOrganizations/org1.example.com/peers/peer1.org1.example.com/tls/ca.crt
...
mkdir -p $PWD/crypto-config/peerOrganizations/org2.example.com/msp/intermediatecerts/
...
cp $PWD/crypto-config/peerOrganizations/org2.example.com/admin/msp/intermediatecerts/*.pem $PWD/crypto-config/peerOrganizations/org2.example.com/msp/intermediatecerts/
...
cat $PWD/crypto-config/peerOrganizations/org2.example.com/admin/msp/intermediatecerts/*.pem >> $PWD/crypto-config/peerOrganizations/org2.example.com/msp/tlscacerts/tlsca.org2.example.com-cert.pem
...
cat $PWD/crypto-config/peerOrganizations/org2.example.com/admin/msp/intermediatecerts/*.pem >> $PWD/crypto-config/peerOrganizations/org2.example.com/users/Admin@org2.example.com/tls/ca.crt
...
cat $PWD/crypto-config/peerOrganizations/org2.example.com/peers/peer0.org2.example.com/msp/intermediatecerts/*.pem >> $PWD/crypto-config/peerOrganizations/org2.example.com/peers/peer0.org2.example.com/tls/ca.crt
...
cat $PWD/crypto-config/peerOrganizations/org2.example.com/peers/peer1.org2.example.com/msp/intermediatecerts/*.pem >> $PWD/crypto-config/peerOrganizations/org2.example.com/peers/peer1.org2.example.com/tls/ca.crt
